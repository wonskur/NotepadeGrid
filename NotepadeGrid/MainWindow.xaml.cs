...
namespace NotepadeGrid
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        private async void BtnOpenFile_Click(object sender, RoutedEventArgs e)
        {
            ...
            var extensions = new[]
            {
                ".txt", ".json", ".xml", ".yaml", ".xaml", ".yml", ".csv", ".tsv",
                ".log", ".md", ".markdown", ".cs", ".js", ".ts", ".py", ".java",
                ".cpp", ".c", ".h", ".go", ".rs", ".php", ".rb", ".swift", ".kt",
                ".lua", ".r", ".html", ".htm", ".css", ".scss", ".sass", ".less",
                ".vue", ".jsx", ".tsx", ".ini", ".cfg", ".conf", ".config",
                ".properties", ".toml", ".pdf", ".doc", ".docx", ".xls", ".xlsx",
                ".ppt", ".pptx", ".rtf", ".odt"
            };
